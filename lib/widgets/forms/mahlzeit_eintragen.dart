...
import 'package:cedmate/widgets/layout/build_list_section.dart';
import 'package:cedmate/widgets/layout/ced_layout.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import '../components/loesche_eintrag.dart';
...
class _MahlzeitEintragenState extends State<MahlzeitEintragen> {
  ...
  final List<String> vorschlaegeZutaten = [
    ...
    'Fettreiche Speisen',
    'Scharfe Gewürze',
    'Rohes Gemüse (z. B. Paprika, Karotte)',
    ...
    'Kaffee / Koffein',
    'Alkohol',
    'Süßstoffe (Sorbitol, Mannitol)',
    'Fruchtzuckerreiche Früchte (Äpfel, Birnen)',
  ];
  final List<String> vorschlaegeUnvertraeglichkeiten = [
    ...
    'Histaminintoleranz',
    'Sorbitintoleranz',
    'Saccharose-Isomaltase-Defizienz',
    'Nicht-zöliakische Glutensensitivität',
    'Fettmalabsorption',
    'Koffeinempfindlichkeit',
    'Empfindlichkeit gegenüber scharfen Gewürzen',
          ...
          child: Column(
            children: [
              ...
              buildListSection(
                ...
                suggestions: vorschlaegeUnvertraeglichkeiten,
                onAdd: () => _addItem(
