...
class EssTagebuchFuerDatum extends StatefulWidget {
  final DateTime filterDatum;

  const EssTagebuchFuerDatum({super.key, required this.filterDatum});

  @override
  State<EssTagebuchFuerDatum> createState() => _EssTagebuchFuerDatumState();
}

class _EssTagebuchFuerDatumState extends State<EssTagebuchFuerDatum> {
  void _zeigeDialogMitElementen(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<Mahlzeit>>(
      stream: mahlzeitService.ladeFuerDatum(widget.filterDatum),
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            final mahlzeit = eintraege[index];
            return Padding(
                        ...
                        Wrap(
                          ...
                          children: [
                            if (mahlzeit.zutaten != null &&
                              ...
                              OutlinedButton.icon(
                                onPressed: () => _zeigeDialogMitElementen(
                                  context,
